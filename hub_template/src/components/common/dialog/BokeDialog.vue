<template>
	...
	>
		<template #header>
			<el-space alignment="center" v-if="showFullScreen">
				<boke-title h3 mode="list">{{ title }}</boke-title>
				<div class="my-dialog-btn" @click="handleFullScreen(true)" title="点击全屏" v-if="!fullScreen && getMinWidth()">
...
const emits = defineEmits(['update:value', 'open', 'close', 'fullScreen'])
