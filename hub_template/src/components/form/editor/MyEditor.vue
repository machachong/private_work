<template>
	<div :style="{ width: width, height: newHeight }" class="editor-wrap">
		...
		<div ref="domRef" :id="id" class="editor" @input="handleInput" @keyup.delete="handleDelete"></div>
		<slot></slot>
...
export default defineComponent({
	...
	emits: ['update:modelValue', 'update:fontSize', 'selected', 'save', 'run', 'format', 'aceInput', 'aceDelete'],
	setup(props, ctx) {
