...
import DemandProgress from '@/views/dw_demand/components/demand_list/DemandProgressMobile.vue'
import DemandInfo from '@/views/dw_demand/components/demand_list/DemandInfo.vue'
