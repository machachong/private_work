<template>
	<div class="homepage">
		<div class="homepage-con" :class="{ dark: isDark }">
			...
			<main class="homepage-list" :class="{ dark: isDark }">
				<template v-for="item in systemGroup" :key="item.name">
					<section class="list" v-if="item.groups.length != 0">
						...
						<div class="list-content">
							<a
								...
								:class="{ dark: isDark }"
								:href="obj.url"
								:target="systemTitle == obj.name ? '' : obj.target"
							>
