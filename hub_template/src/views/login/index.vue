...
export default {
	...
	setup() {
		...
		function redirectToBoke() {
			...
			const url = settings.REDIRECT_URL + '?appId=' + settings.APP_ID + '&extra=' + encodeURIComponent(to)
		...
		function redirectToLogin() {
			...
			const to = route.query.to ? route.query.to : ''
			const redirectUrl = encodeURIComponent(settings.BASE_URL + decodeURIComponent(to))
